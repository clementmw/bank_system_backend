...
urlpatterns = [
    ...
    path('securityquestions/',HandleSecurityQuestions.as_view(), name = "security question during signup"),
    path('resend/verification/',ResendVerificationToken.as_view(), name ="resend verification email"),
